 ...
 */
const SkillDetail = () => {
  // Grab the skill name from the URL (e.g., /skill/Docker -> skillName is 'Docker')
  const { skillName } = useParams();
  const navigate = useNavigate();

  // Look up the skill in our data dictionary. If it's not there, provide generic fallback data.
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 gap-8">
           <div className="space-y-4">
              ...
              >
                Harnessing the full potential of <span className="text-slate-900 dark:text-white">{skillName}</span> through our AI-curated neural learning tunnel.
              </motion.p>
           </div>
